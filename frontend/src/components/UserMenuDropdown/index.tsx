...
type MenuItemProps = { label: string; to?: string; onClick?: () => void }
    ...
    <div className={styles.root} ref={dropdownRef}>
      ...
      {open && (
        <div className={styles.panel}>
          ...
          />
          <MenuItem
            label={t("menu.notifications", { defaultValue: "Уведомления" })}
            to="/notifications"
          />
          <MenuItem
            label={t("menu.whatsNew", { defaultValue: "Что нового" })}
            to="/news"
          />
          <MenuItem
            label={t("menu.logout", { defaultValue: "Выход" })}
